...
export var createPersistedQueryLink = function (options) {
    process.env.NODE_ENV === "production" ? invariant(options && (typeof options.sha256 === 'function' ||
        typeof options.generateHash === 'function'), 24) : invariant(options && (typeof options.sha256 === 'function' ||
    ...
    return new ApolloLink(function (operation, forward) {
        process.env.NODE_ENV === "production" ? invariant(forward, 25) : invariant(forward, 'PersistedQueryLink cannot be the last link in the chain.');
