...
function addTypenameToDocument(doc) {
    return graphql$1.visit(checkDocument(doc), {
        SelectionSet: {
...
function getApolloContext() {
    var context = cache$1.get(React__default.createContext);
    if (!context) {
        context = React__default.createContext({});
        context.displayName = 'ApolloContext';
        cache$1.set(React__default.createContext, context);
    }
    return context;
}
...
var print = function (node) {
    return graphql$1.stripIgnoredCharacters(graphql$1.print(node));
};
...
var ObservableQuery = (function (_super) {
    ...
    function ObservableQuery(_a) {
        ...
        _this.observer = {
            ...
            error: function (error) {
                _this.updateLastResult(tslib.__assign(tslib.__assign({}, _this.lastResult), { error: error, errors: error.graphQLErrors, networkStatus: NetworkStatus.error, loading: false }));
...
var QueryData = (function (_super) {
    ...
    function QueryData(_a) {
        ...
        _this.getQueryResult = function () {
            ...
            if (options.skip) {
                result = tslib.__assign(tslib.__assign({}, result), { data: undefined, error: undefined, loading: false, networkStatus: NetworkStatus.ready, called: true });
            }
